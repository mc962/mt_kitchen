defmodule MTKitchen.Kitchen do
  @moduledoc """
  The Kitchen context. Handles operations relating to recipe and other resource related content.
    Generally meant to be read-only for most use-cases.
  """
