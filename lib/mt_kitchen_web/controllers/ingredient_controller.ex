defmodule MTKitchenWeb.IngredientController do
  ...
  def update(conn, %{"recipe_id" => recipe_id, "id" => id, "step" => step_params}) do
    step = Management.get_full_step!(id)
    ...
    case Management.update_step_ingredients(step, step_params) do
      {:ok, step} ->
        ...
        |> redirect(to: Routes.step_ingredients_path(conn, :edit, step))
