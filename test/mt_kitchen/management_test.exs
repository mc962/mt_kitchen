defmodule MTKitchen.ManagementTest do
  ...
  #      valid_attrs = %{instruction: "some instruction", order: 42, recipe_id: recipe_fixture().id}
  #
  ...
  #
  #      update_attrs = %{
  #        ancestry: "some updated ancestry",
  #        description: "some updated description",
  #        name: "some updated name",
  #        slug: "some updated slug"
  #      }
  ...
  #               Management.update_ingredient(ingredient, update_attrs)
  #
