defmodule MTKitchenWeb.RecipeControllerTest do
  ...
  #  alias MTKitchen.AccountsFixtures
  #
  ...
  ##    conn =
  ##      conn
  ##      |> Map.replace!(:secret_key_base, MTKitchenWeb.Endpoint.config(:secret_key_base))
  ##      |> init_test_session(%{})
  ##
  ##    %{user: AccountFixtures.user_fixture(), conn: conn}
  ##  end
  #
  #  describe "index" do
  ...
  #    setup [:create_recipe]
  #
  #    test "renders form for editing chosen recipe", %{conn: conn, recipe: recipe, user: user} do
  #      conn = UserAuth.log_in_user(user, %{})
  #             |> get(conn, Routes.manage_recipe_path(conn, :edit, recipe))
